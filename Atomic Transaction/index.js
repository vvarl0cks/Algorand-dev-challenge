...
// DO NOT CHANGE
const challenge_id = "3475013087686335165"
...
(async function() {
  try {
    ...
    const txn1 = algosdk.makePaymentTxnWithSuggestedParamsFromObject({
      ...
      to: faucet_addr, // TODO: set to the faucet address
      amount: 1e6,
      suggestedParams: sp,
    });
    ...
    const txn2 = algosdk.makeAssetTransferTxnWithSuggestedParamsFromObject({
      from: acct.addr, // TODO: replace with your address
      to: acct.addr, // TODO: replace with your address
      assetIndex: 10458941, // TODO: replace with the asset id of usdc on testnet
      amount: 0,
      suggestedParams: sp,
    });
