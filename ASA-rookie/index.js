...
// DO NOT CHANGE
const challenge_id = "3475011828333590772"
const client = new algosdk.Algodv2(algod.token, algod.server, algod.port);
let txids = [];

const secretKey = "7GaKn0PKX9ffiPO6VVO5/PiE+CGl8GwXB0u9U0qXKl4/pJjk+ePCfnSsqJnd4Bue4bKcN7EUFl4CgVQC1nfBzQ=="; // TODO: Paste your secret key here. You can find it underneath the code editor. 
...
(async function() {
  try {
    ...
    const txn = algosdk.makeAssetCreateTxnWithSuggestedParamsFromObject({
      ...
      from: acct.addr,     // TODO: The from address should be your address
      assetName: "Task Asset", // TODO: The name should be the string "Task Asset"
      total: 100,     // TODO: The total number of units (should be 100)
      decimals: 2,  // TODO: The number of decimals to display (should be 2)

      manager: acct.addr,   // TODO: The manager address should be your address (should be your address)
      freeze: acct.addr,    // TODO: The address that may issue freeze/unfreeze transactions  (shouuld be your address)
      clawback: acct.addr,  // TODO: The address that may clawback an asset  (should be your address)
      reserve: acct.addr,   // TODO: The account that should be treated as `Reserve` for computing number of tokens in circulation (should be your address)
  ...
  if (await validate(challenge_id, txids)) {
    console.log("Transactions validated! Please return to the developer portal to collect your badge. :)");
  } else {
